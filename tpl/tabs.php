...
$bar->addFields(array(
	...
	GDO_Link::make('link_incoming_friend_requests')->label('link_incoming_friend_requests', [$incoming])->icon('add')->href(href('Friends', 'Requests')),
	GDO_Link::make('link_pending_friend_requests')->icon('add')->href(href('Friends', 'Requesting')),
));
echo $bar->renderCell();
